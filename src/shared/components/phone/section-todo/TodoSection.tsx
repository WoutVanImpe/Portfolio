...
const defaultData: Todo[] = [
	{ id: 1, name: "gordijn", color: "rgba(102, 85, 255, 1)" },
	{ id: 2, name: "lamp", color: "rgba(255, 255, 85, 1)" },
	{ id: 3, name: "lade", color: "rgba(85, 255, 122, 1)" },
	{ id: 4, name: "bol", color: "rgba(255, 85, 136, 1)" },
	{ id: 5, name: "kaart", color: "rgba(255, 147, 85, 1)" },
];
